...
class BERTBiLSTMNERSentimentModel(nn.Module):
    ...
    def forward(self, input_ids, attention_mask):
        ...
        # NER task
        ner_lstm_output, _ = self.ner_lstm(sequence_output)
        ...
        # Sentiment task
        sentiment_lstm_output, _ = self.sentiment_lstm(sequence_output)
...
if __name__ == "__main__":
    ...
    plot_confusion_matrix(
        ...
        title='BERT_BiLSTM_NER_Sentiment Sentiment Analysis Confusion Matrix'
    )
    ...
    plot_metrics_comparison(
        ...
        title='BERT_BiLSTM_NER_Sentiment Performance Comparison'
    )

    save_performance_metrics(
        "BERT_BiLSTM_NER_Sentiment_Both",
        train_losses,
        val_losses,
        metrics,
    ...
    print("Performance metrics saved to 'performance_BERT_BiLSTM_Both.json'")
    ...
    plt.ylabel('Loss')
    plt.legend()
    plt.title('BERT_BiLSTM_NER_Sentiment Training Progress')
    plt.savefig('./performance_improved/training_progress_BERT_BiLSTM_NER_Sentiment.png')
    plt.show()
